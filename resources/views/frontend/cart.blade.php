 ...
 <div class="container">
    <div class="row">
    	...
    	<div class="col-md-12">
            ...
            <tbody>
               ...
               @foreach($cartItems as $item)
                  ...
                  <tr>
                     ...
                     <td>
                        <input type="number" name="num" value="{{ $num }}" class="form-control" style="width: 80px" onchange="updateCart({{ $item->id }}, $(this).val())">
                     </td>
                     <td>
                         {{ number_format($item->discount * $num, 0) }}
                     </td>
                     <td>
         ...
         <h3 style="float: left; font-size: 30px;">Tổng tiền: {{ number_format($total, 0) }}</h3>
