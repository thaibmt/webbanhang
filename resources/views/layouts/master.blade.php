...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('themes/hoaqua/lib/font-awesome/css/font-awesome.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/hoaqua/lib/select2/css/select2.min.css') }}" />
    <link rel="stylesheet" type="text/css"
        href="{{ asset('themes/hoaqua/lib/jquery.bxslider/jquery.bxslider.css') }}" />
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('themes/hoaqua/lib/fancyBox/source/jquery.fancybox.css') }}" />
...
<body>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="header__top__right" style="margin-right:20px;margin-top:5px">
                                <div class="header__top__right__social">
                                    <a href="https://www.facebook.com/tnelectric.com.vn"><i
                                            class="fa fa-facebook"></i></a>
                                    <a href="https://www.facebook.com/tnelectric.com.vn"><i
                                            class="fa fa-twitter"></i></a>
                                    <a href="https://www.facebook.com/tnelectric.com.vn"><i class="fa fa-youtube"
                                            aria-hidden="true"></i></a>
                                    <a href="https://www.facebook.com/tnelectric.com.vn"><i class="fa fa-yahoo"></i></a>
                                </div>
                                <div class="header__top__right__language">
                                    <img width="22" height="18"
                                        src="{{ asset('themes/hoaqua/images/product-detail/vegetables/covietnam.jpg') }}" />
                                    <div>Việt Nam</div>
            ...
            <header class="header_section">
                <div class="container">
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        <a class="navbar-brand" href="{{ route('home_index') }}"><img
                                style='margin-top:-20px;margin-left:30px' width="140"
                                src="{{ asset('themes/frontend/images/logo2.png') }}" alt="#" /></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent"
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item  ">
                                    <a class="nav-link" href="{{ route('home_index') }}">Trang Chủ <span
                                ...
                                <li class="nav-item">
                                    @if ($cartNum > 0)
                                        <label class="badge bg-danger"
                                            style="position: absolute; top: 17px; color: white;font-size:14px">{{ $cartNum }}</label>
                                    @endif
                                ...
                                <form class="form-inline" action="{{ route('frontend.search') }}">
                                    <input style='width:180px;height:30px;border-radius: 10px;' name="s"
                                        placeholder="Tìm kiếm từ khóa..." />
                                    <button class="btn btn-success" type="submit"
                                        style='border-radius: 10px;;margin-left: 6px; margin-bottom: 20px;'>Tìm Kiếm
                                    </button>
    ...
    <!-- footer end -->
    <div class="cpy_">
        <p class="mx-auto">© 2023 All Rights Reserved By <a href="https://www.facebook.com/DoTrungThanh.TamDao">Đỗ
                Trung Thành Vĩnh Phúc</a>
        </p>
    </div>
    <!-- jQery -->
